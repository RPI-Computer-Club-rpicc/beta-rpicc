...
// import {FaCode, FaLaptopCode, FaNetworkWired, FaMicrochip, FaBullhorn, FaShieldAlt, FaBrain, FaPaintRoller ,FaPa} from 'react-icons/fa';
...
const SquadInfo = () => {
  ...
  return (
    <section id="squads" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
            Our Specialized Squads
          </h2>
          <p className="mt-3 max-w-2xl mx-auto text-lg text-gray-500">
            Connect with our dedicated squad leaders to learn more about each specialization
          </p>
        </div>
