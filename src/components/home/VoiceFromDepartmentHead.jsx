              ...
              <div className="h-full w-full bg-gradient-to-br from-sky-500 to-blue-500 p-1">
                <div className="h-full bg-base-100 rounded-lg">
                  <img
                    ...
                    src="https://rajshahi.polytech.gov.bd/sites/default/files/files/rajshahi.polytech.gov.bd/teacher_list/6077f899_0815_4f59_af0b_7caf3e4467fd/2023-11-16-10-19-349548f746400052020b45aefc71aca8.jpg"
                    alt="Department Head"
                  />
                </div>
              </div>
                    ...
                    <div className="flex items-center">
                      <div className="ml-4">
                        ...
                        <div className="text-base-content/70">
                          Department Head (1st shift), Computer Science Department <br />
...
export default VoiceFromDepartmentHead;
